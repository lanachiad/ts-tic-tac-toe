...
function Game() {
  ...
  const gameLoop = (board) => {
    ...
    } else if ((board.board[0][2] && board.board[1][1] && board.board[2][0]) === "X") {
        console.log('USER other diagonal win!!!!!')
    } else if ((board.board[0][0] && board.board[0][1] && board.board[0][2]) === "X") {
        console.log('USER top row win!!!!')
    } else if ((board.board[1][0] && board.board[1][1] && board.board[1][2]) === "X") {
        console.log('USER middle row win!!!!')
    } else if ((board.board[2][0] && board.board[2][1] && board.board[2][2]) === "X") {
    ...
    } else if ((board.board[0][2] && board.board[1][1] && board.board[2][0]) === "O") {
        console.log('AI other diagonal win!!!!!')
    } else if ((board.board[0][0] && board.board[0][1] && board.board[0][2]) === "O") {
        console.log('AI top row win!!!!')
    } else if ((board.board[1][0] && board.board[1][1] && board.board[1][2]) === "O") {
        console.log('AI middle row win!!!!')
    } else if ((board.board[2][0] && board.board[2][1] && board.board[2][2]) === "O") {
